...
### Log Dataset
The second dataset consists of log files in JSON format generated by this event simulator based on the songs in the dataset above. These simulate app activity logs from the imaginary music streaming app based on configuration settings.
...
`README.md` provides a discussion on your process and decisions
